...
#'   h2 <- list(
#'     geo = hier_compute(inp = unique(z2$geo), dim_spec = c(1, 1), root = "Tot"),
#'     year = hier_create(root = "Total", nodes = c("2018", "2019")))
#'   print(h2)
#'   PLSrounding(z2, "freq", hierarchies = lapply(h2, hier_convert))
#' }
